      ...
      try{
        ...
        for(var dayOff=0;dayOff<spDays;dayOff++){
          ...
          for(var si=0;si<6;si++){
            ...
            // Session separator
            if(si>0){
              r1.appendChild(Object.assign(document.createElement('div'),{style:{cssText:'width:'+CS+'px;flex-shrink:0;background:'+(isDk?'rgba(255,255,255,.12)':'rgba(0,0,0,.1)')+';'}}));
              r2.appendChild(Object.assign(document.createElement('div'),{style:{cssText:'width:'+CS+'px;flex-shrink:0;background:'+(isDk?'rgba(255,255,255,.12)':'rgba(0,0,0,.1)')+';'}}));
            }
